...
class _AnimSearchBarState extends State<AnimSearchBar>
  ...
  void search(String input) {
    BlocProvider.of<NavCubit>(context).searchPokemon(input);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      alignment: widget.rtl ? Alignment(1.2, -1.5) : const Alignment(-1.0, 0.0),
      ...
      child: AnimatedContainer(
        ...
        child: Stack(
          children: [
            ...
            AnimatedPositioned(
              duration: Duration(milliseconds: widget.animationDurationInMilli),
              left: (toggle == 0) ? 20.0 : 25.0,
              curve: Curves.easeOut,
              top: 4.0,

              ///NOTE://* Using Animated opacity to change the opacity of the textField while expanding and shrinking
              child: AnimatedOpacity(
                opacity: (toggle == 0) ? 0.0 : 1,
                duration: Duration(milliseconds: 200),
                child: Container(
                  ...
                  child: TextField(
                    ...
                    onEditingComplete: () {
                      ...
                      if (BlocProvider.of<NavCubit>(context).state == -1) {
                        Scaffold.of(context)
                          ..hideCurrentSnackBar()
                        ...
                        unfocusKeyboard();
                        search(widget.textController.text);
                        setState(() {
                          toggle = 0;
                    ...
                    decoration: InputDecoration(
                      prefixIcon: IconButton(
                          onPressed: () {
                            if (BlocProvider.of<NavCubit>(context).state ==
                                -1) {
                              Scaffold.of(context)
                                ..hideCurrentSnackBar()
                                ..showSnackBar(SnackBar(
